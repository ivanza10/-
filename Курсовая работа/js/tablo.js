function updateDateTime() {
    var dateTimeElement = document.getElementById('element1');
    var dateTimeElement2 = document.getElementById('element6');

    var currentDate = new Date();
    var currentDate2 = new Date();

    currentDate.setHours(currentDate.getHours(), currentDate.getMinutes() - 1);
    currentDate2.setHours(currentDate2.getHours() + 2);

    var formattedTime = formatTime(currentDate);
    var formattedTime2 = formatTime(currentDate2);

    dateTimeElement.innerHTML = formattedTime;
    dateTimeElement2.innerHTML = formattedTime2;
}
...
function changeText(buttonNumber) {
    ...
    if (buttonNumber === 1) {
        ...
        newCountry = ' <img src="icon/russia.webp" alt="Логотип"> Россия';
        newTemp = ' А';
        newCan = 'Посадка окончена';

        newCity_2 = 'Дубай';
        newCountry_2 = ` <img src="./icon/turkish.webp" alt="Логотип"> Turkish Airlance`;
        newTemp_2 = ' А';
        ...
        newCity_2 = 'Анталья';
        newCountry_2 = ' <img src="icon/pegasus.webp" alt="Логотип"> Pegasus';
        newTemp_2 = 'А';
